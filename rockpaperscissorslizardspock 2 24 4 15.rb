	...
	def two_player_game
		...
		def play_round
			...
			if @player_one_move[-1] == @player_two_move[-1]
				...
				if ((@player_one_move[-1] == 1  && @player_two_move[-1] == (3)) || #current turn 
					(@player_one_move[-1] == 2  && @player_two_move[-1] == (1)) ||
					(@player_one_move[-1] == 3  && @player_two_move[-1] == (2)) ||
					(@player_one_move[-1] == 4  && @player_two_move[-1] == (2)) ||
					(@player_one_move[-1] == 5  && @player_two_move[-1] == (1))
					add_to_player_score(@player_list[0])
				elsif ((@player_two_move[-1] == 1  && @player_one_move[-1] == (3)) || #current turn 
					   (@player_two_move[-1] == 2  && @player_one_move[-1] == (1)) ||
					   (@player_two_move[-1] == 3  && @player_one_move[-1] == (2)) ||
					   (@player_two_move[-1] == 4  && @player_one_move[-1] == (2) ||
					   (@player_two_move[-1] == 5  && @player_one_move[-1] == (1))
					add_to_player_score(@player_list[1])
				elsif ((@player_one_move[-1] == 1  && @player_two_move[-1] == (4)) || #current turn 
					...
					add_to_player_score(@player_list[0])
				elsif ((@player_two_move[-1] == 1  && @player_one_move[-1] == (4)) || #current turn 
