...
class Player
	...
	def were_we_hit(target)
		if @my_list_of_boats.include?(target) == true
			#the below line is a temporary thing
		#	puts "hit"
			@conf_sym = "X"
		else
		#	puts "miss"
	...
	def show_a_board(num)
		@target_boards[num].display_board
	end
...
#		end
	...
	def players_turn(player_number)
		...
		@player_database[current_player].show_a_board(target_player_real_pos)
